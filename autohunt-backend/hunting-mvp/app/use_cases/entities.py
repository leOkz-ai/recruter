...
def preview_manual_matches(engine, *, mode: str, text_value: str, limit: int = 10) -> dict[str, Any]:
    query_entity, profile = matching_use_cases.build_manual_query_entity(text_value, mode=mode)
    ...
    filtered = [hit for hit in ranked_hits if float(hit.get("sim") or 0.0) >= matching_use_cases.MATCH_THRESHOLD][:limit]
